...
<form id="basicForm" action="form-validation.html" class="form-horizontal">
  <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <h4 class="panel-title">新增监控任务</h4>
        <p>默认的只需要提供一个链接就可以了，如果访问的链接有访问限制则需要提供Cookie信息。</p>
      </div>
      <div class="panel-body">
        <div class="form-group">
          <label class="col-sm-2 control-label">监控地址 <span class="asterisk">*</span></label>
          <div class="col-sm-10">
            <input type="text" name="url" class="form-control" placeholder="请输入监控地址" required />
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="btn-group">
              <button type="button" id="get-sel" class="btn btn-primary btn-sm">GET</button>
              <button type="button" id="post-sel" class="btn btn-default btn-sm">POST</button>
            </div>
            <span class="help-block"><i class="fa fa-exclamation-circle"></i> 默认使用GET方法，当然你也可以自行选择。</span>
          </div>
        </div>
        ...
        <div class="form-group" style="display: none" id="cookie-wrap">
          ...
          <div class="col-sm-10">
            <textarea rows="5" class="form-control" name="cookie" placeholder="请按照规则输入Cookie"></textarea>
      ...
      <div class="panel-footer">
        <div class="row">
          <div class="col-sm-10 col-sm-offset-2">
            <button class="btn btn-primary" id="material-add">提交</button>
          </div>
        </div>
      </div>
